...
!(Images/DockerContainer-Elk.png)
<img src="Images/DockerContainer-Elk.png">
...
- Load balancers are extremely effected again DDOS attacks as they can shift traffic and data around to free space. 
- Jumpboxes are also extremely helpful with keeping your network safe as it is a sole computer at the heart of things to ensure safety.
...
- Filebeat will monitor logs which are being saved on the servers.
- Metricbeat will both monitor and calculate metrics and statistics from the server folloed by putting them into a report.
...
| Web 01   | Network  | 10.0.0.9   |                  |
| Web 02   | Network  | 10.0.0.12  |                  |
| Web 03   | Network  | 10.0.0.13  |                  |
...
|----------|---------------------|----------------------|
| Jump Box |     No              | 10.0.0.9 10.0.0.12   |
|          |                     |                      |
|          |                     |                      |
...
- Update the filebeat-config.yml file to include the Elk VM IP Address.
